...
export default function Record({ video }) {
  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col lg:flex-row gap-10 px-12 lg:px-[100px] mt-12">
        <div className="w-full lg:w-1/2 border-none md:border md:border-r md:border-gray-400">
          <h1 className=" text-5xl font-extrabold">Your video is ready!</h1>
          ...
          <div className="mt-6">
            ...
            <div className="relative flex items-center p-4 text-white rounded-lg home_input w-full md:w-[90%]">
              <input
            ...
            <div>
              <h3 className=" font-semibold text-xl mt-6 mb-1">Video Url</h3>
              <div className="relative flex items-center p-4 text-white rounded-lg home_input w-full md:w-[90%]">
                <span className="text-gray-500 w-[270px] xl:w-[350px] overflow-hidden">
            ...
            <div className="mt-8">
              <h3 className="font-semibold text-base ">Share your video</h3>
              <div className="flex gap-6 mt-2">
                <button className="flex items-center gap-2 w-32 h-12 border border-black pl-2 rounded-md">
                  <svg
                    width="25"
                    height="24"
                    viewBox="0 0 25 24"
      ...
      <div className="save_bg flex items-center justify-center flex-col mt-24 mb-12 py-10 px-12 lg:px-[350px]">
        <h1 className="text-center font-bold text-xl">To ensure the availability and privacy of your video, we recommend saving it to your account.</h1>
        <button className="blue rounded-md text-white font-medium p-2 mt-6">Save Video</button> 
        <h3 className=" text-gray-500 font-bold mt-2 text-lg cursor-pointer">Don't have an account? <span className="text-black hover:underline">Create account</span> </h3>
      </div> 
